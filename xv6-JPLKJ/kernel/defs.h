...
void            procdump(void);
// LLM advisor support — see kernel/procstat.h
struct procstat;
...
// virtio_disk.c  (multi-device: dev=1 fs.img, dev=2 swap.img)
...
int             virtio_console_read(int, uint64, int);
int             virtio_console_write(int, uint64, int);
void            virtio_console_intr(void);
